...
def get_parser():
    ...
    parser.add_argument('-d', '--dataset', type=str, default='translate') # translate  #rotate  # ball  # revolution  # forward  # see dataset_dict in datasets.py  
    parser.add_argument('-c', '--classifier', type=str, default='mlp') # 'lr':logistic regreesion, 'mlp':neural network
...
if __name__ == '__main__':
    ...
    if dim == 2:
        draw_boundary = True
        img_dir = f'{args.dataset}_num_batch_{trainset.num_batch}_cls_all_dp_all_seed_{seed}'
